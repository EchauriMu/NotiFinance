...
router.post('/create', authenticateToken, isAnalyst, predictionController.handleCreatePrediction);

// Actualizar una predicción existente
router.patch('/update/:id', authenticateToken, isAnalyst, predictionController.handleUpdatePrediction);
...
router.delete('/delete/:id', authenticateToken, isAnalyst, predictionController.handleDeletePrediction);
...
router.get('/get/all', authenticateToken, predictionController.handleGetAllPredictions);

// Obtener predicciones por símbolo de criptomoneda
router.get('/get/symbol/:symbol', authenticateToken, predictionController.handleGetPredictionsBySymbol);

// Obtener una predicción específica por ID
router.get('/get/:id', authenticateToken, predictionController.handleGetPredictionById);
