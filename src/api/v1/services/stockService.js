...
/**
 * Función para obtener los datos de la acción desde la API de Twelve Data.
 * Se obtiene el precio de cierre más reciente.
 * 
 * @returns {Promise<number>} El último precio de cierre de la acción.
 */
const getStockData = async () => {
  ...
  // símbolo de la acción (NVDA), intervalo (1 minuto), clave API y zona horaria.
  const params = {
    symbol: 'NVDA',
    interval: '1min',
  ...
  try {
    ...
    console.error('Error al obtener los datos de la acción:', error.message);
    throw error;
  }
};
